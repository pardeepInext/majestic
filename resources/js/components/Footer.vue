<template>
  <section class="py-11">
    <div
      ...
      style="
        background-image: url(/img/gallery/cta.png);
  ...
  <section class="py-0 pt-7">
    <div class="container">
      <div class="row">
        <Footcol :info="companyInfo" />
        <Footcol :info="helpSport" />
        <Footcol :info="customerCare" />
      ...
      <div class="row flex-center my-3">
        ...
        <div class="col-md-6">
          <div class="text-center text-md-end">
            ...
            ><a href="#!">
              <span class="me-4" data-feather="instagram"></span></a
  ...
  data() {
    return {
      companyInfo: {
        ...
        menus: ["About Us", "Affiliate", "Fashion Blogger"],
      },
      helpSport: {
      ...
      customerCare: {
        ...
        menus: ["Contact Us", "Payment Methods", "Bonus Point"],
      },
    };
  },
  components: {
